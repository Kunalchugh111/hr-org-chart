...
.sr-view-pill{position:relative;display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:9px 18px 9px 14px;background:linear-gradient(135deg,#5b21b6 0%,#7c3aed 50%,#c026d3 100%);color:#fff;font-size:0.78rem;font-weight:800;border:none;border-radius:14px;cursor:pointer;font-family:inherit;letter-spacing:0.05em;text-transform:uppercase;box-shadow:0 0 0 3px rgba(124,58,237,0.2),0 8px 22px rgba(124,58,237,0.45),inset 0 1px 0 rgba(255,255,255,0.25);animation:sr-pill-pulse 2s ease-in-out infinite;transition:transform 0.2s cubic-bezier(.34,1.56,.64,1),box-shadow 0.2s ease,filter 0.2s ease;flex-shrink:0;white-space:nowrap;overflow:hidden}
.sr-view-pill::before{content:'';position:absolute;inset:0;background:linear-gradient(120deg,transparent 30%,rgba(255,255,255,0.32) 50%,transparent 70%);transform:translateX(-100%);transition:transform 0.6s ease;pointer-events:none}
.sr-view-pill:hover{transform:translateY(-2px) scale(1.05);animation:none;filter:saturate(1.2) brightness(1.05);box-shadow:0 0 0 6px rgba(124,58,237,0.24),0 14px 32px rgba(192,38,211,0.55),inset 0 1px 0 rgba(255,255,255,0.35)}
.sr-view-pill:hover::before{transform:translateX(100%)}
.sr-view-pill:active{transform:translateY(0) scale(0.98)}
.sr-view-pill .sr-view-pill-ico{font-size:1.05rem;line-height:1;filter:drop-shadow(0 1px 1px rgba(0,0,0,0.25))}
@keyframes sr-pill-pulse{0%,100%{box-shadow:0 0 0 3px rgba(124,58,237,0.2),0 8px 22px rgba(124,58,237,0.45),inset 0 1px 0 rgba(255,255,255,0.25)}50%{box-shadow:0 0 0 9px rgba(192,38,211,0.06),0 10px 28px rgba(192,38,211,0.6),inset 0 1px 0 rgba(255,255,255,0.35)}}
